        ...
        <div className="container mx-auto px-4 py-12">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            ...
            <div className="flex items-center gap-4">
              <Link href="/products">
                <Button variant="outline" className="bg-white/20 border-white text-white hover:bg-white hover:text-[oklch(0.6_0.2_35)]">
                  View All Products
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          <p className="text-[oklch(0.55_0.02_45)] dark:text-[oklch(0.65_0.01_85)]">
            Showing <span className="font-semibold text-[oklch(0.15_0.02_45)] dark:text-white">{initialProducts.length}</span> featured products
          </p>
              ...
              <Link href={`/products/${product.slug}`}>
                <div className="group bg-white dark:bg-[oklch(0.15_0.02_45)] rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-[oklch(0.94_0.01_85)] dark:border-[oklch(0.22_0.02_45)]">
                  ...
                  <div className="relative aspect-square overflow-hidden">
                    ...
                    {/* Featured Badge */}
                    <div className="absolute top-3 left-3 bg-gradient-to-r from-[oklch(0.6_0.2_35)] to-[oklch(0.55_0.15_140)] text-white px-3 py-1.5 rounded-full text-sm font-bold shadow-lg flex items-center gap-1">
                    ...
                    {/* Discount Badge */}
                    {product.discount > 0 && (
                      <div className="absolute top-3 right-3 bg-[oklch(0.6_0.2_35)] text-white px-2 py-1 rounded-full text-xs font-bold">
                        -{product.discount}%
                      </div>
                    )}
                    ...
                    {/* Wishlist Button */}
                    <button className="absolute top-14 left-3 w-8 h-8 bg-white dark:bg-[oklch(0.15_0.02_45)] rounded-full flex items-center justify-center shadow-lg opacity-0 group-hover:opacity-100 transition-opacity hover:bg-gray-100 dark:hover:bg-gray-700">
                      <Heart className="w-4 h-4 text-[oklch(0.55_0.02_45)] dark:text-[oklch(0.65_0.01_85)]" />
                    </button>
                  </div>
                    ...
                    {product.category && (
                      <div className="mt-2">
                        <Link 
                          ...
                          className="text-xs text-[oklch(0.55_0.02_45)] dark:text-[oklch(0.65_0.01_85)] hover:text-[oklch(0.6_0.2_35)] transition-colors"
                        >
